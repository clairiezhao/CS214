...
def load_library():
    try:
        return ctypes.WinDLL("./libkernel.dll")
    except OSError as e:
...
def convert_RGB_to_YCbCr(rgb_pixels, width, height):
    ...
    while i < (width * height * 3):
        ...
        ycc_pixels[i] = round(0.299 * red + 0.587 * green + 0.114 * blue)
        ycc_pixels[i + 1] = round(128 - 0.168736 * red - 0.331264 * green + 0.5 * blue)
        ycc_pixels[i + 2] = round(128 + 0.5 * red - 0.418688 * green - 0.081312 * blue)
